...
import unittest
from array_challenge_advanced import (
    compose,
    pipe,
    memoize,
    zip_with,
...
class TestArrayChallengeAdvanced(unittest.TestCase):
    ...
    def test_compose(self):
        ...
        add3 = lambda x: x + 3
        self.assertEqual(compose(add1, mul2, add3)(5), 17)  # (((5 + 3) * 2) + 1)
    ...
    def test_memoize(self):
        ...
        self.assertEqual(
            call_count, 1
        )  # Function should only be called once for the same input
        ...
        self.assertEqual(
            call_count_multi, 2
        )  # Different argument order should be a different call
    ...
    def test_zip_with(self):
        ...
        self.assertEqual(
            zip_with(lambda x, y, z: x + y + z, [1, 2], [3, 4], [5, 6]), [9, 12]
        )
